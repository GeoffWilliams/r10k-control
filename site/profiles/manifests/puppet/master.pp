class profiles::puppet::master (
    ...
    $db_backup_dir                = hiera("profiles::puppet::master::db_backup_dir",
      $profiles::puppet::params::db_backup_dir),
    $db_backup_hour               = hiera("profiles::puppet::master::db_backup_hour",
      $profiles::puppet::params::db_backup_hour),
    $db_backup_minute             = hiera("profiles::puppet::master::db_backup_minute",
      $profiles::puppet::params::db_backup_minute),
    $db_backup_month              = hiera("profiles::puppet::master::db_backup_month",
      $profiles::puppet::params::db_backup_month),
    $db_backup_monthday           = hiera("profiles::puppet::master::db_backup_monthday",
      $profiles::puppet::params::db_backup_monthday),
    $db_backup_weekday            = hiera("profiles::puppet::master::db_backup_weekday",
      $profiles::puppet::params::db_backup_weekday),
    ...
    $data_binding_terminus        = hiera("profiles::puppet::master::data_binding_terminus", 
      $profiles::puppet::params::data_binding_terminus),
#    $deploy_pub_key      = "",
#    $deploy_private_key  = "",
